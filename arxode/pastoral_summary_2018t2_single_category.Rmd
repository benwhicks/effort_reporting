---
title: "Pastoral Behaviour Summary - 2018 Term 2"
author: "Ben Hicks"
header-includes:
  \usepackage{fancyhdr}
  \pagestyle{fancy}
...
## `r effcat` distribution by house and gender for `r t1`
...
## `r effcat` house distribution from `r min(last4dates)` to `r t1`
